...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/ForgotPassword` | `/ForgotPassword` | `/(auth)/Login` | `/Login` | `/(auth)/Onboarding` | `/Onboarding` | `/(auth)/ResetPassword` | `/ResetPassword` | `/(auth)/VerifyOTP` | `/VerifyOTP` | `/(modals)/AddEstateModal` | `/AddEstateModal` | `/(modals)/AddGoalModal` | `/AddGoalModal` | `/(modals)/AddHoldingsAccountModal` | `/AddHoldingsAccountModal` | `/(tabs)/Notification` | `/Notification` | `/(tabs)/Search` | `/Search` | `/(tabs)/Upload` | `/Upload` | `/(tabs)/_layout` | `/_layout` | `/(tabs)/` | `/(tabs)` | `/+html` | `/.DS_Store` | `/profile/AccountDetail` | `/profile/Detail` | `/profile/HelpSupport` | `/profile/Profile` | `/profile/Settings` | `/profile/TermsCondition`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/${CatchAllRoutePart<T>}` | `/insights/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/[...missing]` | `/insights/[insight]`;
